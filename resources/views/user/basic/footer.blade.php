<button onclick="topFunction()" id="myBtn" title="Go to top"><img src="{{ url('assets/img/chevron-arrow-up.png') }}" style="height:15px;width:15px;"></button>
<footer>
    <div class="bottom">
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-6 mb-2">
                    <form method="POST" action="{{ route('user.index') }}" accept-charset="UTF-8" data-request="onSend">
                ...
                <div class="col-sm-12 col-md-6">
                    ...
                    <br><br>
                    <div class="row">
                        <div class="col-2"><a href="https://www.sme.gov.tw/" target="_blank"><img src="{{ url('assets/img/smea-v2.png') }}" class="bottomPic"></a></div>
