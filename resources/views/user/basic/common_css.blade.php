...
<style type="text/css">
    #st-cmp-v2 .st-cmp-app.st-cmp-twitter-orange h1,
...
<style type="text/css">@import url(https://fonts.googleapis.com/css?family=Open+Sans:300,400,700&display=swap);</style>
<style type="text/css">
    #st-cmp-v2 .st-cmp-app .st-button {
        display: inline-block;
        margin: 5px;
    }
...
<style type="text/css">
    #st-cmp-v2 .st-cmp-app .st-checkbox [type="checkbox"]:not(:checked),
...
<style type="text/css">
    #st-cmp-v2 .st-cmp-app .st-cmp-selection-card {
        margin-top: 20px;
    }
...
<style type="text/css">
    .st-second-layer .st-cmp-nav-buttons {
        margin-top: 20px;
    }
</style>
<style type="text/css">
    #st-cmp-v2 .st-cmp-app .st-cmp-detailed-selection-card {
        margin-top: 20px;
    }
...
<style type="text/css">
    .st-checkbox [type="checkbox"]:not(:checked),
...
<style type="text/css">
    #st-cmp-v2 .st-cmp-app .st-third-layer .st-cmp-selection-cards h2 {
        margin-bottom: 20px;
    }
...
<style type="text/css">
    #st-cmp-v2 .st-cmp-app .st-cmp-vendor-selection-card {
        margin: 0px 0px;
    }
