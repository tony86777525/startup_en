...
<head>
    ...
    <meta property="og:description"
          content="There are 6 municipality government to help entrepreneurs in different stage.">
    <meta property="og:type" content="website">
    <meta property="og:url" content=" https://startup.sme.gov.tw/en/smt ">
    <meta property="og:image" content="http://127.0.0.1:8000/assets/img/bg_SMT.jpg">
    <!-- share api -->
    <script type="text/javascript"
...
<section class="banner-section">
    ...
    <div class="banner-image"
         style="background-image:url('http://127.0.0.1:8000/assets/img/bg_SMT.jpg');opacity:1;"></div>
...
<section style="background-color: rgba(61,186,250,.1);">
    <div class="container" style="padding-bottom: 10px; padding-top:10px;">
        ...
        <div class="mt-4 mb-4 text-center" style="letter-spacing: 1px;">
            ...
            <span class="mr-2"><b>Email: </b></span><a title="teso@mail.taipei.gov.tw"
                                                       href="mailto:teso@mail.taipei.gov.tw">teso@mail.taipei.gov.tw</a>
        </div>
    </div>
</section>
<section>
    <div class="container" style="padding-bottom: 10px; padding-top:10px;">
        ...
        <div class="mt-4 mb-4 text-center" style="letter-spacing: 1px;">
            <a target="_blank"
               title="https://www.economic.ntpc.gov.tw/Custom/New%20Taipei%20City%20OPEN%20FOR%20BUSINESS"
               href="https://www.economic.ntpc.gov.tw/Custom/New%20Taipei%20City%20OPEN%20FOR%20BUSINESS">https://www.economic.ntpc.gov.tw/Custom/New%20Taipei%20City%20OPEN%20FOR%20BUSINESS</a><br>
            <span class="mr-2"><b>Contact: </b></span>+886-2-2960-3456 ext.5293<br> Mrs, Kao of the Company Registration
            division
        </div>
    </div>
</section>
...
<section>
    <div class="container" style="padding-bottom: 10px; padding-top:10px;">
        ...
        <div class="mt-4 mb-4 text-center" style="letter-spacing: 1px;">
            <a target="_blank" title="https://www.invest-taichung.com.tw/en/"
               href="https://www.invest-taichung.com.tw/en/">https://www.invest-taichung.com.tw/en/</a><br>
...
<section>
    <div class="container" style="padding-bottom: 10px; padding-top:10px;">
        ...
        <div class="mt-4 mb-4 text-center" style="letter-spacing: 1px;">
            <a target="_blank" title="https://edbkcg.kcg.gov.tw/en/Default.aspx"
               href="https://edbkcg.kcg.gov.tw/en/Default.aspx">https://edbkcg.kcg.gov.tw/en/Default.aspx</a><br>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-6 mb-2">
                    <form method="POST" action="http://127.0.0.1:8000/smt" accept-charset="UTF-8" data-request="onSend">
                        <input name="_session_key" type="hidden" value="ZYKe7HN3O5kIQwHlwqBpvsXQdTom3XqONyMVFwFa"><input
