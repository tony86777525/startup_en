...
@push('meta')
    ...
    <meta property="og:image" content="{{ url('assets/img/taipei.jpg') }}">
@endpush
...
@section('main')
    ...
    <section class="banner-section">
        ...
        <div class="banner-image" id="banner-image"
             style="background-image:url('/assets/img/taipei.jpg');opacity:1;"></div>
    ...
    <section class="container mt-4">
        <div class="row">
            <div class="text-center col-lg-3 col-md-6">
                <a title="About Taiwan" href="#AboutTaiwan"><img alt="icon" class="pic" src="{{ url('/assets/img/icon1.png') }}"></a>
            ...
            <div class="text-center col-lg-3 col-md-6">
                <a title="News &amp; Story" href="#carouselExampleControls"><img alt="icon" class="pic" src="{{ url('assets/img/icon4.png') }}"></a>
            ...
            <div class="reason-inner">
                <div class="image">
                    <div class="image-inner">
                        <img src="{{ url('assets/img/introduction.jpeg') }}" alt="introduction">
                    </div>
                </div>
                <div class="text">
                    <div class="text-inner">
                        <div style="float:left;">
                            <img alt="earth" src="{{ url('assets/img/earth.png') }}"
                        ...
                        <div style="float:left;margin-top:10px;">
                            <img alt="airplane" src="{{ url('assets/img/airplane.png') }}"
                                 style="width:40px;height:40px;float:left;">
                            <div style="display:inline-block;margin-left:12px;">
                        ...
                        <div style="clear: both;"></div>
                        <div style="float:left;margin-top:10px;">
                            <img alt="hat" src="{{ url('assets/img/hat.png') }}"
                                 style="width:40px;height:40px;float:left;">
                            <div style="display:inline-block;margin-left:12px;">
                        ...
                        <div style="clear: both;"></div>
                        <div style="float:left;margin-top:10px;">
                            <img alt="computer" src="{{ url('assets/img/computer.png') }}"
                                 style="width:40px;height:40px;float:left;">
                        ...
                        <div style="clear: both;"></div>
                        <div style="float:left;margin-top:10px;">
                            <img alt="handshake" src="{{ url('assets/img/handshake.png') }}"
                                 style="width:40px;height:40px;float:left;">
                            <div style="display:inline-block;margin-left:12px;">
