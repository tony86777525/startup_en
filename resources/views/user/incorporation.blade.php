...
@push('meta')
    ...
    <meta property="og:image" content="{{ url('assets/img/bg_incorporation.jpg') }}">
@endpush
...
@section('main')
    ...
    <section class="banner-section">
        ...
        <div class="banner-image" style="background-image:url('{{ url('assets/img/bg_incorporation.jpg') }}');opacity:1;"></div>
    ...
    <section class="entity">
            ...
            <div class="reason-inner">
                <div class="image">
                    <div class="image-inner">
                        <img src="{{ url('assets/img/bg_BE_Type1.jpg') }}" alt="bg_BE_Type1">
                    </div>
                </div>
                <div class="text">
        ...
        <div class="reason right">
            <div class="reason-inner">
                <div class="image">
                    <div class="image-inner">
                        <img src="{{ url('assets/img/bg_BE_Type2.jpg') }}" alt="bg_BE_Type2">
                    </div>
                </div>
                <div class="text">
                    <div class="text-inner">
        ...
        <div class="reason left">
            <div class="reason-inner">
                <div class="image">
                    <div class="image-inner">
                        <img src="{{ url('assets/img/bg_BE_Type3.jpg') }}" alt="bg_BE_Type3">
                    </div>
                </div>
                <div class="text">
                    <div class="text-inner">
