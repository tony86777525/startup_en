...
<head>
    ...
    <meta property="og:url" content=" https://startup.sme.gov.tw/en/innovation">
    <meta property="og:image" content="http://127.0.0.1:8000/assets/img/bg_innovation.png">
    <!-- share api -->
    <script type="text/javascript"
    ...
    <style type="text/css">#st-cmp-v2 .st-cmp-app {
            position: fixed;
            top: 0;
            left: 0;
            z-index: 9999999999;
    ...
    <style type="text/css">#st-cmp-v2 .st-cmp-app.st-cmp-twitter-orange h1,
    ...
    <style
        type="text/css">@import url(https://fonts.googleapis.com/css?family=Open+Sans:300,400,700&display=swap);</style>
    <style type="text/css">#st-cmp-v2 .st-cmp-app .st-button {
            display: inline-block;
            margin: 5px;
        }
    ...
    <style type="text/css">#st-cmp-v2 .st-cmp-app .st-checkbox [type="checkbox"]:not(:checked),
    ...
    <style
        type="text/css">@import url(https://fonts.googleapis.com/css?family=Open+Sans:300,400,700&display=swap);</style>
    <style type="text/css">#st-cmp-v2 .st-cmp-app .st-switch {
            display: block;
            margin: 0 0 20px 0;
            position: relative;
        }
    ...
    <style type="text/css">.st-first-layer h1 {
            margin-bottom: 10px;
            text-align: left;
        }
    ...
    <style
        type="text/css">@import url(https://fonts.googleapis.com/css?family=Open+Sans:300,400,700&display=swap);</style>
    <style type="text/css">.st-dialog3 {
            bottom: 0;
            display: block;
            left: 0;
            position: fixed;
    ...
    <style type="text/css">#st-cmp-v2 .st-cmp-app .st-cmp-selection-card {
            margin-top: 20px;
        }
    ...
    <style type="text/css">.st-second-layer .st-cmp-nav-buttons {
            margin-top: 20px;
        }
    </style>
    <style type="text/css">#st-cmp-v2 .st-cmp-app .st-cmp-detailed-selection-card {
            margin-top: 20px;
        }
    ...
    <style type="text/css">.st-checkbox [type="checkbox"]:not(:checked),
    ...
    <style type="text/css">#st-cmp-v2 .st-cmp-app .st-third-layer .st-cmp-selection-cards h2 {
            margin-bottom: 20px;
        }
    ...
    <style type="text/css">#st-cmp-v2 .st-cmp-app .st-cmp-vendor-selection-card {
            margin: 0px 0px;
        }
...
<div role="dialog" aria-live="polite" aria-label="cookieconsent" aria-describedby="cookieconsent:desc"
     class="cc-window cc-floating cc-type-info cc-theme-classic cc-bottom cc-left cc-color-override-530831885 cc-invisible"
     style="display: none;"><!--googleoff: all--><span id="cookieconsent:desc" class="cc-message">This website uses cookies to ensure you get the best experience on our website. <a
            aria-label="learn more about cookies" role="button" tabindex="0" class="cc-link"
            href="https://www.cookiesandyou.com" rel="noopener noreferrer nofollow"
            target="_blank">Learn more</a></span>
    <div class="cc-compliance"><a aria-label="dismiss cookie message" role="button" tabindex="0"
                                  class="cc-btn cc-dismiss">Got it!</a></div><!--googleon: all--></div>
--&gt;
    ...
    <div class="header-wrapper">
        <div class="center-content">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <a class="navbar-brand" href="http://127.0.0.1:8000" hreflang="en">
                    <img src="http://127.0.0.1:8000/assets/img/Startup-Portal-Taiwan-LOGO.png" height="75"
                         class="d-inline-block align-top" alt="Startup Portal Taiwan" title="Startup Portal Taiwan">
                </a>
                ...
                <div class="collapse navbar-collapse mt-2" id="navbarNavDropdown">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="PRDropDown" data-toggle="dropdown"
                               aria-haspopup="true" aria-expanded="false">
                                Permit &amp; Regulations
                            </a>
                            <div class="dropdown-menu" aria-labelledby="PRDropDown">
                                <a class="dropdown-item" href="http://127.0.0.1:8000/permit" hreflang="en">Visas</a>
                                <a class="dropdown-item" href="http://127.0.0.1:8000/incorporation" hreflang="en">Incorporation</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            <a id="dropdownMenu1" href="#" data-toggle="dropdown" aria-haspopup="true"
                               aria-expanded="false" class="nav-link dropdown-toggle">Service</a>
                            <ul aria-labelledby="dropdownMenu1" class="dropdown-menu border-0 shadow">
                                <li class="dropdown-submenu">
                                    <a id="dropdownMenu2" href="#" role="button" data-toggle="dropdown"
                                       aria-haspopup="true" aria-expanded="false" class="dropdown-item dropdown-toggle">Funding</a>
                                    <ul aria-labelledby="dropdownMenu2" class="dropdown-menu border-0 shadow">
                                        <a class="dropdown-item" href="http://127.0.0.1:8000/incentive" hreflang="en">Government
                                            Incentive</a>
                                        <a class="dropdown-item" target="_blank" href="https://www.contacttaiwan.tw/">Contact
                                            Taiwan</a>
                                    </ul>
                                </li>
                                <li class="dropdown-submenu">
                                    <a id="dropdownMenu3" href="#" role="button" data-toggle="dropdown"
                                       aria-haspopup="true" aria-expanded="false" class="dropdown-item dropdown-toggle">Resource</a>
                                    <ul aria-labelledby="dropdownMenu3" class="dropdown-menu border-0 shadow">
                                        <a class="dropdown-item" href="http://127.0.0.1:8000/ia" hreflang="en">Incubator
                                            &amp; Accelerator</a>
                                        <a class="dropdown-item" href="http://127.0.0.1:8000/smt" hreflang="en">Six
                                            Municipalities of Taiwan</a>
                                    </ul>
                                </li>
                                <li class="dropdown-submenu">
                                    <a id="dropdownMenu4" href="#" role="button" data-toggle="dropdown"
                                       aria-haspopup="true" aria-expanded="false" class="dropdown-item dropdown-toggle">Network</a>
                                    <ul aria-labelledby="dropdownMenu4" class="dropdown-menu border-0 shadow">
                                        <a class="dropdown-item" href="http://127.0.0.1:8000/cc" hreflang="en">Chamber
                                            &amp; Community</a>
                                    </ul>
                                </li>
                                <a class="dropdown-item" href="https://www.startupterrace.tw/" target="_blank">Startup
                                    Terrace Linkou</a>
                                <a class="dropdown-item" href="https://www.yawan-startup.tw/en" target="_blank">Startup
                                    Terrace Kaohsiung</a>
                                <a class="dropdown-item" href="http://127.0.0.1:8000/innovation" hreflang="en">Social
                                    Innovation</a>
                                <a class="dropdown-item" href="https://www.startupislandtaiwan.info/" target="_blank">Startup
                                    Island Taiwan</a>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="NSDropDown" data-toggle="dropdown"
                               aria-haspopup="true" aria-expanded="false">
                                News &amp; Story
                            </a>
                            <div class="dropdown-menu" aria-labelledby="NSDropDown">
                                <a class="dropdown-item" href="http://127.0.0.1:8000/news" hreflang="en">News</a>
                                <a class="dropdown-item" href="http://127.0.0.1:8000/Story" hreflang="en">Story</a>
                            </div>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="https://startup.sme.gov.tw/home/"
                                                hreflang="zh-Hant" target="_blank">Taiwan Start-up</a></li>
                    </ul>
                </div>
            </nav>
        </div>
...
<section class="banner-section">
    ...
    <div class="banner-image"
         style="background-image:url('http://127.0.0.1:8000/assets/img/bg_innovation.png');opacity:1;"></div>
    <h1 class="SIbanner-text">
        Taiwan Social Innovation Entrepreneurship
    </h1>
</section>
<h2 class="mb-4 subtitle" style="background-color: rgba(250,186,144,.2);padding-bottom:30px!important">What is Social
    Innovation?</h2>
<section class="container">
    <div class="row mt-3">
        <div class="col-sm-12 col-lg-6 intro-text">
            Social innovation refers to using innovative methods, such as using technology and cross-disciplinary
            cooperation to find effective solutions to social and environmental problems. We hope that social innovation
            could prosper economy, society, environment, indigenous culture in Taiwan, while adherering to UN’s
            sustainable development goals.
        </div>
        <div class="col-sm-12 col-lg-6">
            <iframe title="Social x Innovation x Impact (2018-5)"
                    src="https://www.youtube.com/embed/CDDYiIYEezc?autoplay=1&amp;amp;feature=oembed" frameborder="0"
                    width="100%" height="300px"></iframe>
        </div>
    </div>
</section>
<h2 class="mt-4 mb-4 subtitle" style="background-color: rgba(250,250,15,.2);padding-bottom:30px!important">Social
    Innovation in Taiwan</h2>
<section class="container">
    <div class="row mt-4">
        <div class="col-lg-12 intro-text">In Taiwan, social innovation has gradually budded under the influence of the
            global trend with diverse forms, including non-profit organizations, cooperatives, and companies. According
            to a survey in 2017, social innovation enterprises in Taiwan consist mostly of new micro-enterprises, which
            are established within the last three years and have a capital less than $160,000. Their operation
            objectives focus on food and agricultural innovation, environmental sustainability/protection, and social
            care.
        </div>
        <div class="intro-block">
            <div class="intro-img"><img alt="Taipei" src="http://127.0.0.1:8000/assets/img/intro-img01.jpg">
            </div>
            <div class="intro-title">Taipei</div>
            <div class="intro-detail">Social Innovation Lab</div>
        </div>
        <div class="intro-block">
            <div class="intro-img"><img alt="Taoyuan"
                                        src="http://127.0.0.1:8000/assets/img/intro-img02.jpeg"></div>
            <div class="intro-title">Taoyuan</div>
            <div class="intro-detail">Social Business Center</div>
        </div>
        <div class="intro-block">
            <div class="intro-img"><img alt="Taichung"
                                        src="http://127.0.0.1:8000/assets/img/intro-img03.jpg"></div>
            <div class="intro-title">Taichung</div>
            <div class="intro-detail">Social Innovation Unit</div>
        </div>
    </div>
</section>
<h2 class="mt-4 mb-4 subtitle" style="background-color: rgba(61,186,250,.2);padding-bottom:30px!important">Our
    Goals</h2>
<section class="container">
    <div class="row mt-5">
        <div class="col-sm-12 col-lg-6 intro-text">
            ...
            The main goal of these acts is to establish a socially innovative and integrated ecological environment,
            explore more social innovation models, and follow the lead of UN’s sustainable development goals.
        </div>
        <div class="col-sm-12 col-lg-6" style="text-align: center">
            <img alt="Goals" src="http://127.0.0.1:8000/assets/img/s3_bottom-540.png"
                 style="width: inherit;max-width: 500px;max-height: 500px">
        </div>
    </div>
</section>
<h2 class="mt-4 mb-4 subtitle" style="background-color: rgba(61,186,144,.2);padding-bottom:30px!important">What we
    achieved</h2>
<section class="container">
    <div class="row achieve">
        <div class="col-sm-12 col-lg-6">
            <h3 class="achieve-subtitle">Awareness</h3>
            <p class="intro-text">We organize various competitions to source and support new solutions to societal
                challenges, and thereby raise awareness about social innovation. One such example is the first
                “Presidential Hackathon” that encourages the Taiwanese government to put innovation in practice and
                address the need for social innovation.</p>
        </div>
        <div class="col-sm-12 col-lg-6">
            <h3 class="achieve-subtitle">Funding</h3>
            <p class="intro-text">We offer subsidy, investment, and financing tools to support social innovation, and
                link CSR resources to cooperate with social enterprises in marketing, procurement, etc.</p>
        </div>
        <div class="col-sm-12 col-lg-6">
            <h3 class="achieve-subtitle">Incubation</h3>
            <p class="intro-text">We established the Social Innovation Lab on 18 October, 2017, as an incubator and
                accelerator that provides resources for social innovation organizations.</p>
        </div>
        <div class="col-sm-12 col-lg-6">
            <h3 class="achieve-subtitle">Regulation</h3>
            <p class="intro-text">We improve the conditions for social innovation and social enterprises in Taiwan
                through the Startup Regulation Harmonization Platform and Deregulation Platform.</p>
        </div>
        <div class="col-sm-12 col-lg-6">
            <h3 class="achieve-subtitle">Promotion</h3>
            <p class="intro-text">We strengthen the cooperation between the private sector and government. The goal is
                to initiate, introduce, and disseminate government policy to foster and encourage social innovation in
                the private sector.</p>
        </div>
        <div class="col-sm-12 col-lg-6">
            <h3 class="achieve-subtitle">Networking</h3>
            <p class="intro-text">We collaborated with private sectors to hold “2018 Asia Social Enterprise Summit” on
                May 5th and 6th. Next year, we will continue to run this event to promote conversations, exchange, and
                cooperation with international partners.</p>
        </div>
    </div>
    <div class="row">
        <div class="mt-3 col-lg-3 col-md-6 col-sm-12">
            <img class="img-fluid img-thumbnail" src="http://127.0.0.1:8000/assets/img/s6_1-535.png"
                 alt="bake">
        </div>
        <div class="mt-3 col-lg-3 col-md-6 col-sm-12">
            <img class="img-fluid img-thumbnail" src="http://127.0.0.1:8000/assets/img/s6_2-535.png"
                 alt="meeting">
        </div>
        <div class="mt-3 col-lg-3 col-md-6 col-sm-12">
            <img class="img-fluid img-thumbnail" src="http://127.0.0.1:8000/assets/img/s6_3-535.png"
                 alt="farm">
        </div>
        <div class="mt-3 col-lg-3 col-md-6 col-sm-12">
            <img class="img-fluid img-thumbnail" src="http://127.0.0.1:8000/assets/img/s6_4-535.png"
                 alt="Tomorrow ASIA">
        </div>
    </div>
    <div class="mt-5" style="text-align: center"><img alt="skyline"
                                                      src="http://127.0.0.1:8000/assets/img/skyline-320.png">
    </div>
</section>
<!-- Footer -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-6 mb-2">
                    <form method="POST" action="http://127.0.0.1:8000/innovation" accept-charset="UTF-8"
                          data-request="onSend"><input name="_session_key" type="hidden"
                                                       value="w41cw748v3welliLD0R83zZ8HuXfAipPieJ7g15S"><input
