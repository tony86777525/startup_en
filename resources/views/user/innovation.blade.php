...
@push('meta')
    ...
    <meta property="og:image" content="{{ url('assets/img/bg_innovation.png') }}">
@endpush
...
@section('main')
    ...
    <section class="banner-section">
        ...
        <div class="banner-image" style="background-image:url('{{ url('assets/img/bg_innovation.png') }}');opacity:1;"></div>
    ...
    <section class="container">
        <div class="row mt-4">
            ...
            <div class="intro-block"><div class="intro-img"><img alt="Taipei" src="{{ url('assets/img/intro-img01.jpg') }}"></div><div class="intro-title">Taipei</div><div class="intro-detail">Social Innovation Lab</div></div>
            <div class="intro-block"><div class="intro-img"><img alt="Taoyuan" src="{{ url('assets/img/intro-img02.jpeg') }}"></div><div class="intro-title">Taoyuan</div><div class="intro-detail">Social Business Center</div></div>
            <div class="intro-block"><div class="intro-img"><img alt="Taichung" src="{{ url('assets/img/intro-img03.jpg') }}"></div><div class="intro-title">Taichung</div><div class="intro-detail">Social Innovation Unit</div></div>
        </div>
    </section>
    ...
    <section class="container">
        <div class="row mt-5">
            ...
            <div class="col-sm-12 col-lg-6" style="text-align: center">
                <img alt="Goals" src="{{ url('assets/img/s3_bottom-540.png') }}" style="width: inherit;max-width: 500px;max-height: 500px">
            </div>
        </div>
    </section>
    ...
    <section class="container">
        ...
        <div class="row">
            <div class="mt-3 col-lg-3 col-md-6 col-sm-12">
                <img class="img-fluid img-thumbnail" src="{{ url('assets/img/s6_1-535.png') }}" alt="bake">
            </div>
            <div class="mt-3 col-lg-3 col-md-6 col-sm-12">
                <img class="img-fluid img-thumbnail" src="{{ url('assets/img/s6_2-535.png')  }}" alt="meeting">
            </div>
            <div class="mt-3 col-lg-3 col-md-6 col-sm-12">
                <img class="img-fluid img-thumbnail" src="{{ url('assets/img/s6_3-535.png') }}" alt="farm">
            </div>
            <div class="mt-3 col-lg-3 col-md-6 col-sm-12">
                <img class="img-fluid img-thumbnail" src="{{ url('assets/img/s6_4-535.png') }}" alt="Tomorrow ASIA">
            </div>
        </div>
        <div class="mt-5" style="text-align: center"><img alt="skyline" src="{{ url('assets/img/skyline-320.png') }}"></div>
    </section>
@endsection
