...
@push('meta')
    ...
    <meta property="og:url" content="{{ url('user.permit') }}">
    <meta property="og:image" content="{{ url('assets/img/bg_permit.jpg') }}">
@endpush
...
@section('main')
    ...
    <section class="banner-section">
        ...
        <div class="banner-image" style="background-image:url('{{ url('assets/img/bg_permit.jpg') }}');opacity:1;"></div>
    ...
    <div class="row" style="margin:25px 0 0;text-align:center">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12" style="margin-bottom:25px">
            <div class="card" style="text-align:center;font-size:1.1rem">
                <img class="card-img-top" src="{{ url('assets/img/bg_visa1.jpg') }}" alt="TEV-bg_img">
                <div class="card-body">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12" style="margin-bottom:25px">
            <div class="card" style="text-align:center;font-size:1.1rem">
                <img class="card-img-top" src="{{ url('assets/img/bg_visa2.jpg') }}" alt="EGC-bg_img">
                <div class="card-body">
    ...
    <div class="visa-content" id="tev">
        ...
        <div style="text-align:center" class="tab-content mb-5" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-FA" role="tabpanel" aria-labelledby="pills-FA-tab">
                <img alt="fa-process-230831" src="{{ url('assets/img/fa-process-230831.png') }}" style="width:80%">
            </div>
            <div class="tab-pane fade" id="pills-HM" role="tabpanel" aria-labelledby="pills-HM-tab">
                <img alt="hm-process-230831" src="{{ url('assets/img/hm-process-230831.png') }}" style="width:80%">
            </div>
        </div>
