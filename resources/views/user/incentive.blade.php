...
@push('meta')
    ...
    <meta property="og:image" content="{{ url('assets/img/bg_incentive.jpg') }}">
@endpush
...
@section('main')
    ...
    <section class="banner-section">
        ...
        <div class="banner-image" style="background-image:url('{{ url('assets/img/bg_incentive.jpg') }}');opacity:1;"></div>
    ...
    <section class="container">
        <div class="row mt-4">
            ...
            <div class="support-block col-lg-4">
                <div class="support-img"><img alt="award" src="{{ url('assets/img/icon_award.png')  }}"></div>
            ...
            <div class="support-block col-lg-4">
                <div class="support-img"><img alt="loan" src="{{ url('assets/img/icon_loan.png') }}"></div>
            ...
            <div class="support-block col-lg-4">
                <div class="support-img"><img alt="grant" src="{{ url('assets/img/icon_grant.png') }}"></div>
    ...
    <section style="background-color:#f9e4a57d;;">
        <section class="container">
            ...
            <div class="mt-4 pb-4" style="letter-spacing: 1px;">
                ...
                <div class="mt-2"></div>
                <b class="mr-2">For More Information<br>Website: </b>
                <a title="industry-incentive.taipei" target="_blank" href="https://www.industry-incentive.taipei/page-about-en.aspx">https://www.industry-incentive.taipei/page-about-en.aspx</a><br>
