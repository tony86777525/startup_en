...
<head>
    ...
    <meta name="Description"
          content="To help startups and entrepreneurs find appropriate organizations and resources efficiently, the SMESA has sorted a list of accelerators or incubators in Taiwan that recognized by the competent authority.">
    ...
    <meta property="og:url" content=" https://startup.sme.gov.tw/en/ia ">
    <meta property="og:image" content="http://127.0.0.1:8000/assets/img/bg_IA.jpg">
    <!-- share api -->
    <script type="text/javascript"
...
<section class="banner-section">
    ...
    <div class="banner-image"
         style="background-image:url('http://127.0.0.1:8000/assets/img/bg_IA.jpg');opacity:1;"></div>
...
<section class="container mb-5">
    <div class="row mt-4">
        <div class="col-lg-12 intro-text">For startups and entrepreneurs, especially on their early stage, incubators
            and accelerators can offer great ways to grow their businesses quickly. With their help and guidance,
            startup teams and entrepreneurs may refine their idea, build out their business plan, work on product-market
            fit, attract venture capital investment, and network in the startup ecosystem.
        </div>
        <div class="col-lg-12 intro-text mt-3 mb-3">To help startups and entrepreneurs find appropriate organizations
            and resources efficiently, the SMESA has sorted a list of accelerators or incubators in Taiwan that
            recognized by the competent authority.
        </div>
        <div class="col-lg-12">
            <div class="mb-2"><b>For More Information</b></div>
            <div class="mb-2"><b>Website: </b>
                <a title="moeasmea" target="_blank" href="https://incubator.sme.gov.tw/en/">https://incubator.sme.gov.tw/en/</a>
            </div>
        </div>
    </div>
</section>
...
<section class="container mb-5">
    <div class="row mt-4">
        <ul style="list-style: none; margin:0 auto;">
            <li>Taiwan Startup Stadium : <a target="_blank" href="//www.startupstadium.tw/">www.startupstadium.tw</a>
            </li>
            <li>Taiwan Startup Terrace (Linkou): <a target="_blank" href="//www.startupterrace.tw/">www.startupterrace.tw</a>
            </li>
            <li>Taiwan Startup Terrace (Kaohsiung): <a target="_blank" href="////www.yawan-startup.tw/en/">www.yawan-startup.tw</a>
            </li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-6 mb-2">
                    <form method="POST" action="http://127.0.0.1:8000/ia" accept-charset="UTF-8" data-request="onSend">
                        <input name="_session_key" type="hidden" value="WRx1i1dTSYrQQpcZtRrUL0TbEyulpFyAqhM2R9lp"><input
