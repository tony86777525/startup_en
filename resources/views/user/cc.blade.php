...
@push('meta')
    ...
    <meta property="og:image" content="{{ url('assets/img/bg_cc.jpg') }}">
@endpush
...
@section('main')
    ...
    <section class="banner-section">
        ...
        <div class="banner-image" style="background-image:url('{{ url('assets/img/bg_CC.jpg') }}');opacity:1;"></div>
    ...
    <section class="container mb-5">
        <div class="row mt-4">
            ...
            <img alt="redroom" src="{{ url('assets/img/redroom.jpg') }}" width="100%">
        </div>
    </section>
@endsection
