...
<head>
    ...
    <meta property="og:url" content=" https://startup.sme.gov.tw/en/Story">
...
<link rel="stylesheet" href="http://127.0.0.1:8000/assets/css/News.css">
<link rel="stylesheet" href="http://127.0.0.1:8000/assets/css/input.css">
                ...
                <div class="collapse navbar-collapse mt-2" id="navbarNavDropdown">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown show">
                            ...
                            <div class="dropdown-menu show" aria-labelledby="NSDropDown">
...
<section>
    <section id="NewsPage" class="container mb-5">
        ...
        <div>The page you requested could not be found. Try refining your search, or use the navigation above to locate
            the post.
        </div>
    </section>
    <!-- Footer -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 col-md-6 mb-2">
                        <form method="POST" action="http://127.0.0.1:8000/Story" accept-charset="UTF-8"
                              data-request="onSend"><input name="_session_key" type="hidden"
                                                           value="A8COZtVGAkDkzXVb0AatMUF49frgXb0NpPtrdoXB"><input
                    ...
                    <div class="col-sm-12 col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-10">
                                <div class="bottomTitle">Small and Medium Enterprise and Startup Administration,
