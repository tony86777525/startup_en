...
<head>
    ...
    <meta property="og:url" content=" https://startup.sme.gov.tw/news">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-6 mb-2">
                    <form method="POST" action="http://127.0.0.1:8000/news" accept-charset="UTF-8"
                          data-request="onSend"><input name="_session_key" type="hidden"
                                                       value="D4AQFAlYyI7HyRljvXZTCTGhqt2afXvHisvIu5Ch"><input
